...
################################################################################
    ...
    apt_install pwgen -y
    echo -e "$GREEN Sussessfully installed Required packages...$COL_RESET"
	sleep 3
    ...
    echo -e "$GREEN Sussessfully installed Required crypto Compile packages...$COL_RESET"
    ...
    echo -e "$GREEN Sussessfully sent email...$COL_RESET"
